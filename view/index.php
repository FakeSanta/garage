              ...
              <div class="col-sm-12">
                <div class="card-body">
                  ...
                  <div class="table-responsive text-nowrap">
                    <?php
                      $check_ct = $connect->prepare("SELECT * FROM VEHICULE, RDV, CT WHERE VEHICULE.id = CT.id_vehicule   AND VEHICULE.id = RDV.id_vehicule   AND rdv_pris = 0   AND rdv_annule = 0   AND prochaine_date_ct < DATE_ADD(CURDATE(), INTERVAL 360 DAY) ORDER BY date_ct ASC");
                      $check_ct->execute();
